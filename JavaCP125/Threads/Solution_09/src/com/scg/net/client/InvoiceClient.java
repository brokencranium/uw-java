...
public final class InvoiceClient extends Thread {
   ...
   /** The host of the server. */
    ...
    public void run() {
        ...
        try {
            ...
            try {
                ...
                logger.log(Level.SEVERE, "Unable to close socket output stream.", ex);
            }
            try {
                if (server != null) {
                    server.close();
                ...
                logger.log(Level.SEVERE, "Unable to close connection to server.", ex);
            }
        }
    }
    ...
    /**
     * Connect to the server and send the quit command to the server.
     */
