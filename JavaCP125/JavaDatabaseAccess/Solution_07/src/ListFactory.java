...
public final class ListFactory {
    ...
    /** This class' logger. */
    private static final Logger logger = Logger.getLogger("InitLists");
    ...
    public static void populateLists(final List<ClientAccount> clients,
        ...
        timeCard.addConsultantTime(new ConsultantTime(currentDay, clients.get(SECOND_CLIENT_NDX),
                Skill.SOFTWARE_ENGINEER, STD_WORK_DAY));
        logger.log(Level.FINEST, "Created first TimeCard: ",
                timeCard.toString());
        ...
        timeCard.addConsultantTime(new ConsultantTime(currentDay, NonBillableAccount.VACATION,
                Skill.SOFTWARE_ENGINEER, STD_WORK_DAY));
        logger.log(Level.FINEST, "Created second TimeCard: ",
                timeCard.toString());
        timeCards.add(timeCard);
        ...
        timeCard.addConsultantTime(new ConsultantTime(currentDay, clients.get(SECOND_CLIENT_NDX),
                Skill.SYSTEM_ARCHITECT, STD_WORK_DAY));
        logger.log(Level.FINEST, "Created third TimeCard: ",
                timeCard.toString());
        timeCards.add(timeCard);
        ...
        timeCard.addConsultantTime(new ConsultantTime(currentDay, clients.get(SECOND_CLIENT_NDX),
                Skill.SYSTEM_ARCHITECT, STD_WORK_DAY));
        logger.log(Level.FINEST, "Created forth TimeCard: ",
                timeCard.toString());
        timeCards.add(timeCard);
    }
